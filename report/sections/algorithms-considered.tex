...
\begin{itemize}
    \item Linear Regression (\cite{preethi_optimizing_2025})
    \item Lasso Regression (\cite{preethi_optimizing_2025})
    \item Ridge Regression (\cite{preethi_optimizing_2025})
    \item Elastic Net Regression (\cite{preethi_optimizing_2025})
    \item Support Vector Regressor (\cite{preethi_optimizing_2025})
    \item K-Nearest Neighbour Regressor (\cite{yan_survey_2020})
    \item Random Forest Regressor (\cite{yan_survey_2020})
    \item XGBoost Regressor (\cite{yan_survey_2020})
    \item XGBoost Random Forest Regressor (\cite{yan_survey_2020})
\end{itemize}
