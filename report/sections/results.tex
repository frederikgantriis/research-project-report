...
All of these experiments were done on an Intel CPU and an Nvidia RTX 3080 GPU.

Looking at all the presented results, it becomes clear that \svr is missing from the visualisation. This is due to experimentation taking more time than initially planned, and all experiments were therefore removed. This pattern was shown when running the given model on both CPU and GPU. This means that while \svr might have provided good results, testing and experimentation were focused on hyper-parameter tuning other models with shorter completion times.
